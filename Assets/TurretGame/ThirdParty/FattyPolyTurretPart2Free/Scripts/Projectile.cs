...
public class Projectile : MonoBehaviour {
    ...
    public string redPlaneTag = "RedPlane";
    public string greenPlaneTag = "GreenPlane";
    public string rainbowPlaneTag = "RainbowPlane";
    ...
    {
        if (other.transform.tag ==  redPlaneTag || other.transform.tag == greenPlaneTag || other.transform.tag == rainbowPlaneTag)
        {
